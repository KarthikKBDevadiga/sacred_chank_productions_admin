...
export default function ProfileScreen({
  ...
  const saveProfile = () => {
    let isValid = true;
    isValid =
      genericValidator(firstName, setFirstNameError, "First Name") && isValid;
    isValid =
      genericValidator(lastName, setLastNameError, "Last Name") && isValid;
    if (isValid) {
      ...
      console.log(body);
      let status = 200;
      fetch(process.env.BASE_API_URL + "users", {
        method: "put",
