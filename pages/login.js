        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="px-6 py-6 bg-gray-700 shadow sm:rounded-lg ">
            ...
            {/* <div className="mt-6">
              ...
              <Link href="/signup">
                <a className="inline-flex justify-center w-full px-4 py-2 mt-4 text-sm font-medium text-gray-500 duration-500 bg-white border border-gray-300 rounded-md shadow-sm cursor-pointer hover:bg-green-600 hover:text-white">
                  REGISTER
                </a>
              </Link>
            </div> */}
